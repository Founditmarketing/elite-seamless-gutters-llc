        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl opacity-80">
              Founded on the principles of architectural integrity and elite craftsmanship, Elite Seamless Gutters LLC has been Central Louisiana's trusted protector for decades.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                ...
                <div className="p-8 bg-white/5 liquid-shield">
                  ...
                  <p className="text-sm">Deeply rooted in the Alexandria and Pineville communities with decades of trusted service.</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-12">
              <div className="p-12 bg-sapphire/20 border border-azure/20 liquid-shield">
                <h3 className="text-2xl font-bold mb-6 text-silver">Why Choose Elite</h3>
                <ul className="space-y-6">
                  <li className="flex items-start space-x-4">
                    <BadgePercent className="text-azure shrink-0" size={24} />
                    <div>
                      <h4 className="text-silver font-bold">Competitive Pricing</h4>
                      <p className="text-sm">We offer fair, transparent pricing with no hidden costs. What we quote is what you pay.</p>
                    </div>
                  </li>
                  <li className="flex items-start space-x-4">
                    <Users className="text-azure shrink-0" size={24} />
                    <div>
                      <h4 className="text-silver font-bold">Experienced Team</h4>
                      <p className="text-sm">Our skilled crew delivers quality craftsmanship and professional service on every project.</p>
                    </div>
                  </li>
                </ul>
              </div>
